...
class SettingsController extends StateNotifier<SettingsState> {
  ...
  Future<void> setSaveWindowPlacement(bool saveWindowPlacement) async{
    state = state.copyWith(saveWindowPlacement: saveWindowPlacement,);
  ...
  Future<void> onToggleAutoStartLaunchHidden() async {
    if (state.autoStart) {
      ...
      if (success) {
        state = state.copyWith(autoStartLaunchHidden: !state.autoStartLaunchHidden,);
  ...
  Future<void> setEnableMessageBar(bool enableMessageBar) async {
    state = state.copyWith(enableMessageBar: enableMessageBar,);
  ...
  Future<void> setDownloadFileFormat(DownloadFileFormatEnum downloadFileFormat) async {
