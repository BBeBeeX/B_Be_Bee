...
class AppDelegate: FlutterAppDelegate {
    ...
    override func applicationShouldTerminateAfterLastWindowClosed(_ sender: NSApplication) -> Bool {
        // b_be_bee handles the close event manually
        return false
    }
    ...
    override func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        let b_be_beeBrandColor = NSColor(red: 0, green: 0.392, blue: 0.353, alpha: 0.8) // #00645a
        DockProgress.style = .squircle(color: b_be_beeBrandColor)
    ...
    private func setupStatusBarItem(i18n: [String: String]) {
        ...
        if let button = statusItem?.button {
            ...
            let openItem = NSMenuItem(title: openString, action: #selector(showb_be_beeFromMenuBar), keyEquivalent: "o")
    ...
    @objc func showb_be_beeFromMenuBar() {
        channel?.invokeMethod("showb_be_beeFromMenuBar", arguments: nil)
    }
